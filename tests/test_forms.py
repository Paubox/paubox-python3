...
class TestPauboxFormsClientInit(TestCase):
    ...
    def test_default_base_url(self):
        ...
        self.assertEqual(client.base_url, "https://api.paubox.com/forms")
...
class TestGetForm(TestCase):
    ...
    def test_get_form_calls_correct_url(self, mock_get):
        ...
        client = PauboxFormsClient(base_url="https://api.paubox.com/forms")
        client.get_form(FORM_ID)
        mock_get.assert_called_once_with(
            f"https://api.paubox.com/forms/public/form_data/{FORM_ID}",
...
class TestSubmitForm(TestCase):
    ...
    def test_submit_form_calls_correct_url(self, mock_post):
        ...
        self.assertEqual(args[0], f"https://api.paubox.com/forms/api/forms/{FORM_ID}/submissions")
